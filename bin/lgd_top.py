...
from Maindock.util.analysis import read_ranking_file
...
log = LoggingManager.get_logger("dock_top")
...
if __name__ == "__main__":
    ...
    # Read ranking file
    predictions = read_ranking_file(args.dock_ranking_file)

    # Destination path is the same as the output
    destination_path = os.path.dirname(args.dock_ranking_file)
