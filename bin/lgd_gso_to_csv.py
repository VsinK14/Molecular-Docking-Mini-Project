...
"""Translates a output file to CSV format"""
...
log = LoggingManager.get_logger("dock2csv")
DEFAULT_SEP = ","


def parse_command_line():
    parser = argparse.ArgumentParser(prog="dock2csv")
    parser.add_argument("ranking_file", help="dock ranking file name")
