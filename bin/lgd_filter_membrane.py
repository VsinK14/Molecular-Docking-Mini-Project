...
"""Filter final swarm results depending on the compatibility with the membrane"""
...
def parse_command_line():
    ...
    parser.add_argument(
        ...
        help="Receptor PDB parsed by Dock",
...
if __name__ == "__main__":
    ...
    for pdb_file in structures:
        try:
            ...
            glowworm_id = int(re.findall(r"dock_\d+", pdb_file)[0].split("_")[-1])
