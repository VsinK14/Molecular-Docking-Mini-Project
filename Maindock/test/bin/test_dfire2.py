...
class TestRegressionDFIRE2Short(RegressionTest):
    ...
    def test_2uuy_5_steps_25_glowworms_100_swarms(self):
        ...
        command = f"dock3.py -c 1 -s dfire2 setup.json {steps} -l 10 >> test_dock.out"
        os.system(command)
...
class TestRegressionDFIRE2Restraints(RegressionTest):
    ...
    def test_2uuy_5_steps_25_glowworms_rst(self):
        ...
        command = f"dock3.py -c 1 -s dfire2 setup.json {steps} -l 0 >> test_dock.out"
        os.system(command)
...
class TestRegressionDFIRE2Long(RegressionTest):
    ...
    def test_2uuy_40_steps_50_glowworms(self):
        ...
        command = f"dock3.py -c 1 -s dfire2 setup.json {steps} -l 100 >> test_dock.out"
        os.system(command)
