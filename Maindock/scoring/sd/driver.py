...
import Main.scoring.sd.energy.c.sd as sd
from Maindock.util.logger import LoggingManager
from Maindock.scoring.sd.data.amber import amber_types, masses, charges
import Maindock.scoring.sd.data.vdw as vdw
