...
import numpy as np
import os
from Maindock.Param import DEFAULT_PREFIX
from Maindock.scoring.functions import ScoringFunction, ModelAdapter
from Maindock.structure.model import DockingModel
from Maindock.scoring.sipper.data.energy import sipper_energy, res_to_index
import Main.scoring.sipper.c.sipper as csipper
