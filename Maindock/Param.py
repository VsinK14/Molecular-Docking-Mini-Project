...
DEFAULT_REC_NM_FILE = "dock_rec.nm"
DEFAULT_LIG_NM_FILE = "dock_lig.nm"

"""Scoring function constants"""
# Default scoring function if none is specified
...
# centered at origin of coordinates (use together with Docking receptor parsed PDB)
...
DEFAULT_INFO = "dock.info"
DEFAULT_MASK_FILE = "dock_%s_mask" + NUMPY_FILE_SAVE_EXTENSION
