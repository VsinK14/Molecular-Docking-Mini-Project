...
from Maindock.prep.starting_points import calculate_surface_points
from Maindock.Math.lrandom import MTGenerator, NormalGenerator
from Main.Math.cython.quaternion import Quaternion
from Main.Math.cython.cutil import distance as cdistance
from Main.Math.cython.cutil import norm
...
from Maindock.prep.geometry import create_bild_file
from Maindock.structure.residue import Residue
from Maindock.error.app_error import (
    DockWarning,
    MembraneSetupError,
    StructureError,
)
