...
from searchspace.landscape import (
    LandscapePosition,
    DockingLandscapePosition,
)
from Math.lrandom import MTGenerator
...
class DockFromFileInitializer(Initializer):
    ...
    def __init__(
        ...
        super(DockFromFileInitializer, self).__init__(
