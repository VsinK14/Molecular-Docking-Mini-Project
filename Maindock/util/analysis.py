...
class DockingResult(object):
    """Represents a docking result line"""
...
def read_output(file_name, initial=None, final=None):
    """Reads a output file and sorts it by energy"""
...
def read_cluster_representatives_file(cluster_file_name):
    """Reads a cluster representatives file"""
